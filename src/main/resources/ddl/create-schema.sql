CREATE TABLE jpaforbeginners.public.tbl_persons (ID BIGINT NOT NULL, col_birthday DATE NOT NULL, col_dateinsert timestamp, col_dateupdate timestamp, col_deathdate DATE, col_firstname VARCHAR(150) NOT NULL, col_gender CHAR(1) NOT NULL, col_height FLOAT, col_weight FLOAT, PRIMARY KEY (ID))
...
ALTER TABLE jpaforbeginners.public.tbl_addresses ADD CONSTRAINT fk_tbl_addresses_persons_id FOREIGN KEY (person_id) REFERENCES tbl_persons (ID)
