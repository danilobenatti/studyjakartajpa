CREATE TABLE jpaforbeginners.public.persons (ID BIGINT NOT NULL, peType VARCHAR(1), birthdate DATE NOT NULL, dateinsert TIMESTAMP WITH TIME ZONE, dateupdate TIMESTAMP WITH TIME ZONE, deathdate DATE, firstname VARCHAR(150) NOT NULL, gender CHAR(1) NOT NULL, height NUMERIC(3,2) default 0.0, weight NUMERIC(3,1) default 0.0, partner_id BIGINT, PRIMARY KEY (ID))
