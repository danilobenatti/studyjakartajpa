...
CREATE TABLE jpaforbeginners.public.products (ID BIGINT NOT NULL, active BOOLEAN, dateinsert TIMESTAMP WITH TIME ZONE, dateupdate TIMESTAMP WITH TIME ZONE, description VARCHAR(255) NOT NULL, discount NUMERIC(4,2) default 0.0, title VARCHAR(150) NOT NULL, unit SMALLINT NOT NULL, unitPrice DECIMAL(18,2) NOT NULL, validity DATE, PRIMARY KEY (ID))
...
CREATE TABLE EMPLOYEE (ID BIGINT NOT NULL, hiringDate DATE NOT NULL, jobfunction SMALLINT NOT NULL, register VARCHAR(255) NOT NULL, salary DECIMAL(18,2), PRIMARY KEY (ID))
